# Generated by Django 3.0.5 on 2020-07-20 09:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('report', '0104_auto_20200720_1704'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lC_MS', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='report.LC_MS', verbose_name='液相色谱串联质谱平台')),
            ],
            options={
                'verbose_name': 'AB',
                'verbose_name_plural': 'AB',
            },
        ),
        migrations.CreateModel(
            name='Agilent_LC_MS',
            ...
            options={
                'verbose_name': 'Agilent',
                'verbose_name_plural': 'Agilent',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aB_LC_MS', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='report.AB_LC_MS', verbose_name='AB')),
            ],
            options={
                'verbose_name': '项目名称',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Shimadzu',
                'verbose_name_plural': 'Shimadzu',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Organic_comparison', models.CharField(blank=True, max_length=32, verbose_name='有机相比例')),
                ('Flowrate', models.CharField(blank=True, max_length=32, verbose_name='流速')),
                ('project_Shimadzu_LC_MS', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='report.Project_Shimadzu_LC_MS', verbose_name='项目名称')),
            ],
            options={
                'verbose_name': '液相方法',
                'verbose_name_plural': '液相方法',
        ...
        migrations.RemoveField(
            model_name='project_manufacturer_lc_ms',
            name='manufacturer_LC_MS',
        ),
        migrations.RemoveField(
            model_name='yx_project_manufacturer_lc_ms',
            name='project_Manufacturer_LC_MS',
        ),
        migrations.RemoveField(
            model_name='zp_project_manufacturer_lc_ms',
            name='project_Manufacturer_LC_MS',
        ),
        ...
        migrations.AddField(
            ...
            name='shimadzu_LC_MS',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='report.Shimadzu_LC_MS', verbose_name='Shimadzu'),
        ),
    ]
