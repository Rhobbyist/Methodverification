# Generated by Django 3.0.5 on 2020-08-05 06:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('report', '0119_auto_20200805_1125'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reagents', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='report.Reagents', verbose_name='主要试剂')),
            ],
            options={
                'verbose_name': '描述性内容',
        ...
        migrations.CreateModel(
            name='Consumables_texts',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField(max_length=200, verbose_name='描述性内容')),
                ('consumables', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='report.Consumables', verbose_name='主要耗材')),
            ],
            options={
                'verbose_name': '描述性内容',
                'verbose_name_plural': '描述性内容',
