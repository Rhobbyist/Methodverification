...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('report', '0061_auto_20200612_1708'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='pjjmdmethod',
            name='PJJMD_key',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, to='report.PJJMD', verbose_name='中间精密度'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='pjjmdtexts',
            name='PJJMD_key',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='report.PJJMD', verbose_name='中间精密度'),
            preserve_default=False,
        ),
