# Generated by Django 3.0.5 on 2020-07-30 06:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('report', '0111_auto_20200730_1126'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=500, verbose_name='质谱方法描述性内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField(max_length=500, verbose_name='液相方法描述性内容')),
                ('project_AB_LC_MS', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='report.Project_AB_LC_MS', verbose_name='项目名称')),
            ],
            options={
